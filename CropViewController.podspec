Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/Mosoink/TOCropViewController'
  s.author   = 'Tim Oliver'
  s.source   = { :git => 'https://github.com/Mosoink/TOCropViewController.git'}
  # s.source   = { :git => 'https://github.com/Mosoink/TOCropViewController.git', :tag => s.version }
  s.platform = :ios, '8.0'
